            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  [Placeholder text] We collect information you provide directly
                  to us, such as when you create an account, make a purchase, or
                  contact us for support. This may include your name, email
                  address, phone number, and payment information.
                </p>
                <p className="text-gray-600">
                  [Replace with your actual data collection practices and types
              ...
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  [Placeholder text] We use the information we collect to
                  provide, maintain, and improve our services, process
                  transactions, and communicate with you about your account and
                  our services.
                </p>
              ...
              <section>
                ...
                <p className="text-gray-600">
                  [Placeholder text] We do not sell, trade, or otherwise
                  transfer your personal information to third parties without
                  your consent, except as described in this policy. We may share
              ...
              <section>
                ...
                <p className="text-gray-600">
                  [Placeholder text] We implement appropriate security measures
              ...
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  [Placeholder text] You have certain rights regarding your
