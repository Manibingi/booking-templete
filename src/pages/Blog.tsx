      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <CardContent>
                  <div className="flex justify-between items-center">
                    ...
                    <Button variant="outline" size="sm" className="hover:scale-105 transition-transform duration-300" asChild>
                      <Link to={`/blog/${post.id}`} className="bg-white border-2 border-primary text-primary hover:bg-bgcolor1 hover:text-white">Read More</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="text-center mb-16 animate-fade-in" style={{ animationDelay: "0.9s" }}>
            <Button size="lg" variant="outline" className="hover:scale-105 transition-transform duration-300 hover:bg-bgcolor1 hover:text-white">
              Load More Posts
            </Button>
          </div>
          ...
          <div className="bg-gradient-to-r from-primary to-primary/80 text-white rounded-lg p-12 text-center animate-fade-in" style={{ animationDelay: "1s" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              />
              <Button variant="secondary" className="px-8 hover:scale-105 transition-transform duration-300 hover:bg-bgcolor1 hover:text-white">
                Subscribe Now
              </Button>
            </div>
