      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {services.map((service, index) => (
              ...
              >
                ...
                <CardHeader>
                  <CardTitle className="text-2xl textcolor2">{service.title}</CardTitle>
                  <CardDescription>{service.description}</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="text-3xl font-bold textcolor2 mb-6">{service.price}</div>
          ...
          <div className="bg-gray-50 rounded-lg p-12 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <h2 className="text-3xl font-bold text-center textcolor3 mb-12">Why Choose Our Services?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={benefit} className="text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2 textcolor2">{benefit}</h3>
