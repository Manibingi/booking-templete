  ...
  return (
    ...
    >
      <CardHeader className="pb-4">
        ...
        <CardTitle className="text-xl leading-tight textcolor2">{title}</CardTitle>
      ...
      <CardContent className="pt-0">
        <div className="flex justify-between items-center">
          ...
          <Button variant="outline" size="sm" asChild className="hover:scale-110 transition-transform duration-300">
            <Link to={`/blog/${id}`} className="bg-white border-2 border-primary text-primary hover:bg-bgcolor1 hover:text-white">Read More</Link>
          </Button>
        </div>
      </CardContent>
    </Card>
