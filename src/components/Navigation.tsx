      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-8">
                  ...
                  <NavigationMenuItem key={item.name}>
                    ...
                    >
                      ...
                      {isActivePath(item.path) && (
                        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-1 h-1 bgcolor1 rounded-full"></div>
                      )}
                    </Link>
                  </NavigationMenuItem>
                ))}
                ...
                <NavigationMenuItem>
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button className="flex items-center px-3 py-2 rounded-lg text-md font-medium text-gray-700 transition-all duration-300">
                        Pages
            ...
            <Button className="ml-6 text-md gradient1 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              Get Started
            </Button>
          </div>
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-lg text-gray-600 hover:text-green-700 hover:bg-primary/5 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary transition-all duration-300"
            >
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white/95 backdrop-blur-md border-t border-gray-100 shadow-lg">
          <div className="px-4 pt-4 pb-6 space-y-2">
            ...
            <div className="pt-4">
              <Button className="w-full gradient1 shadow-lg">
                Get Started
              </Button>
            </div>
          </div>
